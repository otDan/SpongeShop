...
public class Page implements Displayable {
    ...
    public Page define(List<Element> elements) {
        ...
        for (int i = 1; i <= pages; i++) {
            views.add(view.build(container).define(Layout.builder()
                    ...
                    .replace(CURRENT, createElement("Current Page", i, 330))
    ...
    private Element createElement(String name, int page, int target) {
        ...
        if(target == 330) {
            item = ItemStack.builder()
                    ...
                    .add(Keys.DISPLAY_NAME, Text.of(name, " (", page, ")"))
                    .quantity(page)
                    .build();
            item.offer(Keys.DYE_COLOR, DyeColors.WHITE);
        }
        else {
            item = ItemStack.builder()
                    ...
                    .quantity(target)
                    .build();
            item.offer(Keys.DYE_COLOR, page == target ? DyeColors.RED : DyeColors.LIGHT_BLUE);
        }
    ...
    public static class Builder implements Displayable.Builder {
        ...
        private final View.Builder view = View.builder();
